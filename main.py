        ...
        if connection:
            ...
            if request.method == 'POST':
                ...
                if profile_image and allowed_file(profile_image.filename):
                    ...
                    ext = secure_filename(profile_image.filename).rsplit('.', 1)[1].lower()
                    ...
                    old_image = cursor.fetchone().get('profile_image')
                    
                    # Delete the old profile image if it exists
                    if old_image:
                        old_image_path = os.path.join(app.root_path, old_image)
